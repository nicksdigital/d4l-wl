...
contract D4LLayerZeroBridgeAdapter is ID4LBridgeAdapter, Ownable, Pausable, ReentrancyGuard {
    ...
    constructor(
        ...
        require(_lzEndpoint != address(0), "D4LLayerZeroBridgeAdapter: lzEndpoint cannot be zero address");
        require(_router != address(0), "D4LLayerZeroBridgeAdapter: router cannot be zero address");
