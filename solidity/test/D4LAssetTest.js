...
describe("D4L Asset Tests", function () {
  ...
  beforeEach(async function () {
    ...
    const erc20AssetEvent = erc20AssetReceipt.logs.find(
      log => log.fragment && log.fragment.name === "ERC20AssetDeployed"
    );
    const erc20AssetAddress = erc20AssetEvent.args[1];
    ...
    const erc721AssetEvent = erc721AssetReceipt.logs.find(
      log => log.fragment && log.fragment.name === "ERC721AssetDeployed"
    );
    const erc721AssetAddress = erc721AssetEvent.args[1];
