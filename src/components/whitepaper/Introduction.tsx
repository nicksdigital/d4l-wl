    ...
    <section id="introduction" className="mb-24">
      ...
      <div className="relative mb-16 overflow-hidden">
        ...
        <div className="relative p-10 text-center">
          <h3 className="text-3xl md:text-4xl font-bold mb-4 text-white drop-shadow-glow">
            Ride the D4L Wave: <span className="text-blue-300">Risk It</span>, <span className="text-purple-300">Build It</span>, <span className="text-green-300">Bank It</span>
          </h3>
      ...
      <div className="relative mb-16 p-8 bg-gradient-to-br from-purple-900/30 to-blue-900/30 rounded-xl border border-white/10 backdrop-blur-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
          {[
            ...
            <div key={index} className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 transform transition-all duration-300 hover:scale-[1.03] hover:shadow-lg shadow-[0_8px_30px_rgb(0,0,0,0.12)]">
              <div className="flex items-center mb-4">
                <div className={`inline-flex items-center justify-center p-3 rounded-lg bg-gradient-to-r ${feature.color} text-white mr-4`}>
                  {feature.icon}
                </div>
              ...
              <div className={`h-1 w-16 mt-4 rounded-full bg-gradient-to-r ${feature.color}`}></div>
            </div>
          ))}
        </div>
      </div>
