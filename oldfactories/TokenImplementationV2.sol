...
import "./interfaces/ITokenImplementationV2.sol";

/**
 * @title TokenImplementationV2
 * @dev Improved version of the token implementation with additional features
 */
contract TokenImplementationV2 is TokenImplementation, ITokenImplementationV2 {
     ...
     * We're using _update in the newer OZ version
     */
    function _update(
        address from,
        address to,
